...
function translateToCpp17()
    ...
    if curr > total
        warning(['Attempted to translate file ''',M_filename,''' with no code.'])
        return
    end
    ...
    function writeCatchStmt(node)
        if nodes(LHS,node)==NONE
            ...
            %DO THIS: support named exceptions
    ...
    % # <https://en.cppreference.com/w/cpp/keyword C++ Reserved Keywords>
